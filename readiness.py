...
class Dashboard(tk.Frame):
    ...
    def _build_header(self):
        ...
        tk.Label(hdr, text="⬡ SUPPLIER READINESS", bg=PANEL, fg=ACCENT,
                 font=("Courier New", 18, "bold")).pack(side="left", padx=16, pady=10)
    ...
    def _build_filters(self):
        ...
        tk.Button(bar, text="RESET", bg=BORDER, fg=ACCENT,
                  ...
                  command=self._reset_filters).pack(side="left", padx=12)
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        candidates = [
            os.path.join(here, "Copy of Data set examples_Main.xlsx"),
