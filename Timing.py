...
df = pd.read_excel("JLR Coursework\Data set examples_Main.xlsx", sheet_name= "Timing")
...
dropdownProgramme.bind("<<ComboboxSelected>>", dashboard)
dropdownPlatform.bind("<<ComboboxSelected>>", dashboard)
StatDropdown.bind("<<ComboboxSelected>>", dashboard)
search.trace_add("write", dashboard)
